...
export class SentimentCacheService {
    ...
    async getCachedData(countries: string[]): Promise<{ [key: string]: CountrySentiment | null }> {
      ...
      const result: { [key: string]: CountrySentiment | null } = {};
    ...
    async updateCache(country: string, data: CountrySentiment): Promise<void> {
    ...
    async bulkUpdateCache(data: { [country: string]: CountrySentiment }): Promise<void> {
